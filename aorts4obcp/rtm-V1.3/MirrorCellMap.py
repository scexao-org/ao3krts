...
# Given gui mirror-cell number, return actual dm number
def dmNumber(guiNumber):
    dmNumbers = range(188, 0)
    return (dmNumbers[guiNumber])
...
if __name__ == "__main__":
    ...
    for guiNumber in range(188):
        print("GuiNumber:%d = %d" % (guiNumber, dmNumbers[guiNumber]))
