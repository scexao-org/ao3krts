...
# NECESSARY SPOOFING -- this is the best way to carry it
# over into each and every tmux
export MILK_SHM_DIR="/tmp/milk_shm_dir_pytest"

export CACAO_LOOPNAME="nir3ktest"
export CACAO_LOOPNUMBER="107" # MUST BE CHANGED TO AVOID COLLISION IN TMUX SPACE
...
#
export CACAO_DMINDEX="164"    # Hardware DM - connected to physical DM
export CACAO_DMSIMINDEX="165" # Simulation DM
