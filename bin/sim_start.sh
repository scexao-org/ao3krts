...
echo -e "\n"
echo -e "\e[1;32mStart CACAO SIMULATOR\e[0m \n"
echo -e "\n"
echo -e "\n"

# load configuration file
echo -e "\e[1;32mSim:Load CACAO Simulator configuration file... \e[0m \n"
source /home/rts/AOloop/cacaovars.ao188lhs.bash
sleep 5
echo -e "\n"
echo -e "\e[1;31mCACAO configuratin file loaded. \e[0m \n"
sleep 3
echo -e "\e[1;31mLoaded pararameters for CACAO... \e[0m \n"
cacao-setup -p 
sleep 5
# start conf process (DM comb etc...)
echo -e "\e[1;32mSim:Start CACAO setup: start configuration process... \e[0m \n"
cacao-setup
sleep 15
echo -e "\n"
echo -e "\e[1;31mCACAO setup started (conf process ON). \e[0m \n"
echo -e "\e[1;33mprocess running in:\e[0m \n"
echo -e "\e[1;33mSee tmux a -t ao188lhs_fpsCTRL\e[0m \n"
echo -e "\n"
echo -e "\n"

# start running process
echo -e "\e[1;32mSim:Start CACAO setup: start running process... \e[0m \n"


# Sim - Dm comb 01
#echo "confstart DMcomb-01" >> /milk/shm/ao188lhs_fpsCTRL.fifo
echo "runstart DMcomb-01" >> /milk/shm/ao188lhs_fpsCTRL.fifo
sleep 5

# Sim - StreamDelay 01
#echo "confstart streamDelay-01" >> /milk/shm/ao188lhs_fpsCTRL.fifo
echo "runstart streamDelay-01" >> /milk/shm/ao188lhs_fpsCTRL.fifo
sleep 5

# Sim - simmvmgpu-1
#echo "confstart simmvmgpu-1" >> /milk/shm/ao188lhs_fpsCTRL.fifo
echo "runstart simmvmgpu-1" >> /milk/shm/ao188lhs_fpsCTRL.fifo
sleep 5

# Sim - acquWFS-1
#echo "confstart acquWFS-1" >> /milk/shm/ao188lhs_fpsCTRL.fifo
echo "runstart acquWFS-1" >> /milk/shm/ao188lhs_fpsCTRL.fifo
sleep 5
...
#echo "confstart loopRUN-1" >> /milk/shm/ao188lhs_fpsCTRL.fifo
echo "runstart loopRUN-1" >> /milk/shm/ao188lhs_fpsCTRL.fifo
sleep 5
...
echo -e "\e[1;31m START g2if ... \e[0m\n"
