...
class RtmControlSupervisor:
    ...
    def stop_all(self):
        ...
        self.howfs_loop.graceful_stop() # Kill gain, let decay, loopON = OFF, restore gain
    ...
    def reconfigure_lgs(self):
        ...
        self.lowfs_loop.reconfigure_matrices(TTF MATRIX)
        self.lowfs_loop.restart_processes()

        self.spin_up_defocus_offloader(FROM LO OR FROM HI)
        ...
        def handover_tt():
            ...
            increase_gain_tt_offloader incrementally
